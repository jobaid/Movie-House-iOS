// Comdey movie / Comdey movie / Comdey movie / Comdey movie / Comdey movie / Comdey movie / Comdey movie / Comdey 
...
class StageshowViewController: UIViewController,GADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        if connectedToNetwork() == true {
            Timer.scheduledTimer(timeInterval: TimeInterval(180), target: self, selector: #selector(StageshowViewController.loadad), userInfo: nil, repeats: false)
    ...
    func getdata(){
        Alamofire.request("https://bflix-f20b8.firebaseio.com/.json").responseJSON { (responseData) -> Void in
            if((responseData.result.value) != nil) {
                ...
                if let resData = swiftyJsonVar["comedy"].arrayObject {
    ...
    @objc func setupPullToRefresh() {
        ...
        self.refreshControl.addTarget(self, action: #selector(StageshowViewController.refresh), for: UIControlEvents.valueChanged)
